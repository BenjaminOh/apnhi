...
export default function MainSection1() {
    return (
        <div className="overflow-hidden">
            <div className="relative mx-auto flex max-w-[1360px] flex-col gap-[24px] p-[40px_20px_0] md:gap-[40px] md:p-[80px_28px_0] xl:flex-row xl:items-start xl:p-[120px_28px_65px] min-[1400px]:px-0">
                <Image
                ...
                />
                <div className="relative z-[1] xl:flex-1">
                ...
                <ul className="relative z-[1] grid w-full max-w-[1000px] grid-cols-1 gap-[20px] md:grid-cols-2 xl:grid-cols-3">
                    {list.map((item, i) => (
                        <li key={`main_section1_item_${i}`}>
                            <div className="group relative w-full overflow-hidden rounded-[20px] bg-gradient-to-b from-[#FFFFFF] to-[#F8F8F8] py-[24px] text-center md:rounded-[40px] md:py-[60px] xl:h-[440px]">
