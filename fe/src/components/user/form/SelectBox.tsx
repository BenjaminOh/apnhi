...
const SelectBox = React.forwardRef<HTMLButtonElement, SelectBoxProps>(
    (
        ...
        const boxClass = twMerge(
            "h-[48px] w-auto min-w-[160px] bg-[#F7F7F7] px-[16px] shadow-none border-none text-[16px] ring-[#F7F7F7] rounded-[8px] leading-1 ring-inset ring-1 focus:ring-1 focus:ring-[#F7F7F7] focus:ring-offset-0 data-[state=open]:ring-[#F7F7F7] data-[placeholder]:text-[#999] [&>svg]:opacity-100",
            triggerClassName,
        );
