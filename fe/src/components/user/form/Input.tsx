...
const Input = forwardRef<HTMLInputElement, InputProps>(
    (
        ...
        const inputStyle = twMerge(
            "w-full h-[48px] px-[16px] text-[#222] rounded-[8px] bg-[#F7F7F7] focus:border focus:border-primary placeholder:text-[#666] disabled:bg-[#F8F8F8] transition duration-200",
            className,
        );
        return (
            <>
