...
import pagingFirst from "@/assets/images/console/pagingFirst.svg";
import pagingLast from "@/assets/images/console/pagingLast.svg";
import pagingNext from "@/assets/images/console/pagingNext.svg";
import pagingPrev from "@/assets/images/console/pagingPrev.svg";
                    ...
                    <li key={`page_${i}`}>
                        <button
                            ...
                            className={`size-[30px] rounded-[8px] text-[18px] font-[500]${
                                currentPage === page ? " bg-[#23AA4B] text-white" : ""
                            }`}
                        >
                            {page}
                        </button>
