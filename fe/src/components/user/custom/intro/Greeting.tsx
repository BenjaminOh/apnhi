                ...
                <div className="mx-auto max-w-[1360px] xl:flex xl:justify-end xl:pl-[560px]">
                    <div className="xl:w-[680px]">
                        <div className="text-[18px] leading-[1.5] text-[#666] md:text-[20px]">
                            ...
                            <br />
                            <br />  우리 연구소는 국내외 역사 갈등의 주요 요소인 역사교재의 문제점들을 분석하고 다양한
                            대안을 모색하는 활동을 주요 업무로 삼고 있습니다. 구체적으로 한중일의 연구자, 교사가
                            참여하는 공동부교재 작성 사업을 진행하고 있습니다. 또 한중일 연구자, 교사, 시민활동가 등이
                            매년 3국을 순회하며 ‘역사인식과 동아시아 평화포럼’을 개최하고 동북아시아의 주요 역사 갈등
                            요인인 일본의 전쟁범죄와 식민지범죄와 청산 작업의 현황을 점검하면서 세계사적인 보편성 획득을
                            위한 활동을 전개하고 있습니다. 나아가 미래의 동아시아를 이끌어 갈 청소년들을 대상으로
