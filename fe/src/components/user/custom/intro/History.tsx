        ...
        history: [
            {
                ...
                list: [
                    ...
                    {
                        date: `10. 30 ~ 11. 03`,
                        text: `제14회 역사인식과 동아시아 평화포럼 오키나와대회(일본 오키나와)`,
                    },
            ...
            },
            {
                ...
                list: [
                    ...
                    { date: `08. 05 ~ 08. 10`, text: `제13회 동아시아 청소년 역사체험캠프(한국 천안)` },
            ...
            },
            {
                ...
                list: [
                    ...
                    { date: `04. 22`, text: `특별 초청 강연회-이치노헤 쇼코 ‘풀뿌리 과거청산의 실천’(역사문제연구소)` },
                    ...
                    { date: `08. 07 ~ 08. 12`, text: `제12회 한중일 청소년 역사체험캠프(일본 교토)` },
            ...
            },
            {
                ...
                img: history2012,
                list: [
                    { date: `05. 29`, text: `『한중일이 함께 쓴 동아시아 근현대사』 1~2권 출판` },
                    {
                        date: `06. 20`,
                        text: `『한중일이 함께 쓴 동아시아 근현대사』 출판 기념 특강, '이제, 3국의 시선으로 동아시아를 읽는다!'(가톨릭청년회관)`,
                    },
                    {
                        date: `06. 22`,
                        text: `역사인식 공유를 위한 동아시아 국제심포지엄 '동아시아 근현대사를 어떻게 기술할 것인가-『한중일이 함께 쓴 동아시아 근현대사』 출판을 기념하며'`,
                    },
                    { date: `07. 25 ~ 07. 30`, text: `제11회 동아시아 청소년 역사체험캠프(중국 대련)` },
                    { date: `09. 16`, text: `제4차 한중일 공통교재 전문가 워크샵(일본 도쿄대학)` },
                    {
                        date: `09. 20`,
                        text: `『한중일이 함께 만든 동아시아 3국의 근현대사-미래를 여는 역사』 개정판 출판`,
                    },
                    {
                        date: `10. 19`,
                        text: `『新しい東アジアの近現代史』 (『한중일이 함께 쓴 동아시아 근현대사』 일본어판) 출판`,
                    },
                    { date: `11. 23 ~ 11. 27`, text: `제11회 역사인식과 동아시아 평화포럼(일본 도쿄)` },
                    { date: `11. 26`, text: `제35회 한중일3국공동역사교재편찬위원회 국제회의(일본 도쿄)` },
                ],
            },
            {
                year: "2011",
                img: history2011,
                list: [
                    { date: `01. 29 ~ 01. 30`, text: `제31회 한중일3국공동역사교재편찬위원회 국제회의(중국 베이징)` },
                    { date: `03. 04 ~ 03. 06`, text: `제32회 한중일3국공동역사교재편찬위원회 국제회의(중국 베이징)` },
                    { date: `04. 30 ~ 05. 03`, text: `제33회 한중일3국공동역사교재편찬위원회 국제회의(중국 베이징)` },
                    { date: `08. 04 ~ 08. 09`, text: `제10회 동아시아 청소년 역사체험캠프(한국 인천)` },
                    { date: `11. 26 ~ 11. 28`, text: `제10회 역사인식과 동아시아 평화포럼(중국 베이징)` },
                    { date: `11. 28`, text: `제34회 한중일3국공동역사교재편찬위원회 국제회의(중국 베이징)` },
                ],
            },
        ],
    },
        ...
        history: [
            {
                ...
                img: history2010,
                list: [
                    { date: `04. 02 ~ 04. 05`, text: `제26회 한중일3국공동역사교재편찬위원회 국제회의(일본 도쿄)` },
                    { date: `06. 25 ~ 06. 29`, text: `제27회 한중일3국공동역사교재편찬위원회 국제회의(중국 베이징)` },
                    { date: `08. 04 ~ 08. 09`, text: `제9회 동아시아 청소년 역사체험캠프(일본 치바)` },
                    { date: `09. 10`, text: `제2차 한중일 공통교재 실현을 위한 전문가 워크숍` },
                    { date: `09. 10 ~ 09. 13`, text: `제28회 한중일3국공동역사교재편찬위원회 국제회의(한국 서울)` },
                    { date: `11. 19 ~ 11. 23`, text: `제9회 역사인식과 동아시아 평화포럼(서울)` },
                    {
                        date: `11. 21 ~ 11. 24`,
                        text: `『A HISTORY TO OPEN THE FUTURE』 (한중일이 함께 만든 동아시아 3국의 근현대사-미래를 여는 역사 영어판) 출판`,
                    },
                    { date: `11. 21 ~ 11. 24`, text: `제29회 한중일3국공동역사교재편찬위원회 국제회의(서울)` },
                    { date: `12. 28 ~ 12. 30`, text: `제30회 한중일3국공동역사교재편찬위원회 국제회의(중국 베이징)` },
                ],
            },
            {
                year: "2009",
                img: history2009,
                list: [
                    { date: `03. 20 ~ 03. 23`, text: `제23회 한중일3국공동역사교재편찬위원회 국제회의(한국 서울)` },
                    { date: `06. 12`, text: `'지유샤판' 역사 교과서 분석 심포지엄 개최` },
                    { date: `08`, text: `제8회 동아시아 청소년 역사체험캠프는 신종인플루엔자로 취소` },
                    { date: `08. 27 ~ 08. 31`, text: `제24회 한중일3국공동역사교재편찬위원회 국제회의(중국 베이징)` },
                    { date: `09. 04 ~ 09. 08`, text: `제1회 한일 청년 평화포럼(일본 후쿠오카)` },
                    { date: `11. 19 ~ 11. 23`, text: `제8회 역사인식과 동아시아 평화포럼(일본 도쿄)` },
            ...
            },
            {
                ...
                img: history2008,
                list: [
                    { date: `01. 25 ~ 01. 28`, text: `제20회 한중일3국공동역사교재편찬위원회 국제회의(일본 도쿄)` },
                    {
                        date: `06. 25`,
                        text: `미래사총서 1권 『동아시아에서 역사인식의 국경 넘기』 출판 <br/>미래사총서 2권 『역사인식을 둘러싼 자화상, 외부의 시선』 출판`,
                    },
                    { date: `06. 27 ~ 06. 30`, text: `제21회 한중일3국공동역사교재편찬위원회 국제회의(한국 제주)` },
                    { date: `08. 06 ~ 08. 11`, text: `제7회 동아시아 청소년 역사체험캠프(중국 난징)` },
                    { date: `11. 02 ~ 11. 05`, text: `제22회 한중일3국공동역사교재편찬위원회 국제회의(중국 베이징)` },
                    { date: `12. 31`, text: `미래사총서 3권 『한중일 동아시아사 교육의 현황과 과제』 출판` },
                ],
            },
            {
                year: "2007",
                img: history2007,
                list: [
                    { date: `01. 31`, text: `『어린이의 미래를 여는 역사』 1~3권 출판` },
                    { date: `04. 13 ~ 04. 16`, text: `제17회 한중일3국공동역사교재편찬위원회 국제회의(중국 베이징)` },
                    { date: `07. 20 ~ 07. 23`, text: `제18회 한중일3국공동역사교재편찬위원회 국제회의(중국 베이징)` },
                    { date: `08. 07 ~ 08. 12`, text: `제6회 동아시아 청소년 역사체험캠프(한국 제주)` },
                    { date: `09. 15 ~ 09. 18`, text: `제6회 역사인식과 동아시아 평화포럼(한국 서울)` },
                    { date: `09. 16 ~ 09. 17`, text: `제19회 한중일3국공동역사교재편찬위원회 국제회의(한국 서울)` },
                ],
            },
            {
                year: "2006",
                img: history2006,
                list: [
                    { date: `01. 06 ~ 01. 09`, text: `제4회 역사인식과 동아시아 평화포럼(중국 베이징)` },
                    { date: `01. 07 ~ 01. 08`, text: `제14회 한중일3국공동역사교재편찬위원회 국제회의(중국 베이징)` },
                    { date: `05. 14 ~ 05. 15`, text: `제15회 한중일3국공동역사교재편찬위원회 국제회의(일본 도쿄)` },
                    { date: `08. 03 ~ 08. 10`, text: `제5회 동아시아 청소년 역사체험캠프(일본 오키나와)` },
                    { date: `11. 02 ~ 11. 05`, text: `제16회 한중일3국공동역사교재편찬위원회 국제회의(일본 교토)` },
                    { date: `11. 02 ~ 11. 06`, text: `제5회 역사인식과 동아시아 평화포럼(일본 교토)` },
                ],
            },
        ],
    },
        ...
        history: [
            {
                ...
                list: [
                    ...
                    { date: `04. 17 ~ 04. 19`, text: `제11회 한중일3국공동역사교재편찬위원회 국제회의(중국 베이징)` },
                    {
                        date: `05. 26`,
                        text: `『한중일이 함께 만든 동아시아 3국의 근현대사-미래를 여는 역사』 출판 기자회견 및 출판기념회`,
                    },
                    { date: `06. 09`, text: `후소샤 교과서 불채택을 위한 국제심포지엄(서울)` },
                    {
                        date: `07.`,
                        text: `『東亞三國的近現代史-以史爲鑑 面向未來』(『한중일이 함께 만든 동아시아 3국의 근현대사-미래를 여는 역사』 중국어판) 출판`,
                    },
                    { date: `08. 03 ~ 08. 10`, text: `제4회 동아시아 청소년 역사체험캠프(중국 베이징)` },
                    { date: `10.`, text: `공익성기부금단체로 지정(재경부)` },
                    { date: `10. 13 ~ 10. 14`, text: `제12회 한중일3국공동역사교재편찬위원회 국제회의(일본 도쿄)` },
                    { date: `11. 03 ~ 11. 06`, text: `2005년 후소샤 교과서 불채택운동 평가 심포지엄(강화도)` },
                ],
            },
            {
                year: "2004",
                img: history2004,
                list: [
                    { date: `02. 18`, text: `아시아평화와역사연구소 창립` },
                    { date: `04. 29`, text: `아시아평화와역사연구소 비영리사단법인 설립` },
                    { date: `05. 27 ~ 05. 29`, text: `제6회 한중일3국공동역사교재편찬위원회 국제회의(일본 도쿄)` },
                    { date: `08. 08 ~ 08. 10`, text: `제7회 한중일3국공동역사교재편찬위원회 국제회의(안양)` },
                    { date: `08. 08 ~ 08. 13`, text: `제3회 역사인식과 동아시아 평화포럼(서울)` },
                    { date: `09. 20`, text: `제8회 한중일3국공동역사교재편찬위원회 국제회의(중국 베이징)` },
                    { date: `10. 29 ~ 10. 31`, text: `제9회 한중일3국공동역사교재편찬위원회 국제회의(중국 난징)` },
                ],
            },
            {
                year: "2003",
                img: history2003,
                list: [
                    { date: `02. 27 ~ 03. 01`, text: `제2회 역사인식과 동아시아 평화포럼(일본 도쿄)` },
                    { date: `07. 25 ~ 07. 30`, text: `제2회 동아시아 청소년 역사체험캠프(일본 교토)` },
                    { date: `09. 08 ~ 09. 09`, text: `제3회 한중일3국공동역사교재편찬위원회 국제회의(중국 베이징)` },
                    {
                        date: `11. 21 ~ 11. 24`,
                        text: `국제학술대회 ‘동아시아역사공동체-한중일 공동의 역사인식을 위해’`,
                    },
                    { date: `11. 22 ~ 11. 24`, text: `제4회 한중일3국공동역사교재편찬위원회 국제회의(서울)` },
            ...
            },
            {
                ...
                img: history2002,
                list: [
                    { date: `03. 27 ~ 03. 31`, text: `제1회 역사인식과 동아시아 평화포럼(중국 난징)` },
                    { date: `08. 18 ~ 08. 22`, text: `제1회 동아시아 청소년 역사체험캠프(서울)` },
                    { date: `08. 23 ~ 08. 25`, text: `제1회 한중일3국공동역사교재편찬위원회 국제회의(서울)` },
                    { date: `12. 23`, text: `제2회 한중일3국공동역사교재편찬위원회 국제회의(일본 도쿄)` },
                ],
            },
            {
                year: "2001",
                img: history2001,
                list: [{ date: `04. 23`, text: `상설연대기구 ‘일본교과서바로잡기운동본부’ 창립(86개 단체 참여)` }],
            },
        ],
    },
];
